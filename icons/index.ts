...
export { default as MenuIcon } from "./menu-icon/menu-icon";
export { default as TabCalendarIcon } from "./tab-calendar-icon/tab-calendar-icon";
export { default as TabDashboardIcon } from "./tab-dashboard-icon/tab-dashboard-icon";
export { default as TabStatsIcon } from "./tab-stats-icon/tab-stats-icon";
