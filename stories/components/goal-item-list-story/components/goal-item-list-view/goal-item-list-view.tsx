...
const BASE_GOALS: GoalType[] = [
  { id: 1, name: "Goal 1", status: "IN_PROGRESS", color: "FF8A3D" },
  { id: 2, name: "Goal 2", status: "IN_PROGRESS", color: "4CAF50" },
  { id: 3, name: "Goal 3", status: "IN_PROGRESS", color: "2196F3" },
  { id: 4, name: "Goal 4", status: "IN_PROGRESS", color: "9C27B0" },
];
